        ...
        <b-col lg="4" md="6">
          ...
          <b-form>
            ...
            <div class="input-group">
              ...
              ></Icon>
              <b-form-invalid-feedback class="invalid-tooltip position-absolute top-100 start-0"
            ...
            <b-col lg="4">
              ...
              <b-collapse id="useful_links" class="d-lg-block" data-bs-parent="#footer-links">
                <ul class="nav flex-column pb-lg-1 mb-lg-3">
                  ...
                  <li class="nav-item">
                    <a href="#" class="nav-link d-inline-block px-0 pt-1 pb-2">Case Studies</a>
                  </li>
                  <li class="nav-item">
                    <a href="#" class="nav-link d-inline-block px-0 pt-1 pb-2">About Us</a>
                  </li>
                  <li class="nav-item">
                    <a href="#" class="nav-link d-inline-block px-0 pt-1 pb-2">News & Insights</a>
                  </li>
                </ul>
