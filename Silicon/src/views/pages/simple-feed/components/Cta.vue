<template>
  <section class="py-5 bg-secondary">
    <b-container class="py-md-3 py-lg-5">
      <b-row class="justify-content-center">
        <b-col xl="8" lg="9" md="11">
          <h2
          ...
          >
            ...
            <!-- Arrow shape -->
            <svg
              class="d-md-block d-none position-absolute top-0 ms-4 ps-1"
              style="left: 100%"
          ...
          <!-- Title + checkboxes -->
          <b-row class="gy-4 align-items-center mb-lg-5 mb-4 pb-3">
            <div class="col-md-3">
              <h3 class="h5 mb-0 text-sm-start text-center">Sign up for Newsletters</h3>
            </div>
            <b-col md="9">
              <b-row class="row-cols-sm-3 row-cols-2 gy-2">
                <b-col>
                  <div class="mb-0">
                    <b-form-checkbox id="s-daily-newsletter">Daily Newsletter</b-form-checkbox>
                  </div>
                </b-col>
                <b-col>
                  <div class="mb-0">
                    <b-form-checkbox id="s-advertising-updates"
                      >Advertising Updates</b-form-checkbox
                    >
                  </div>
                </b-col>
                <b-col>
                  <div class="mb-0">
                    <b-form-checkbox id="s-week-in-review">Week in Review</b-form-checkbox>
                  </div>
                </b-col>
                <b-col>
                  <div class="mb-0">
                    <b-form-checkbox id="s-event-updates">Event Updates</b-form-checkbox>
                  </div>
                </b-col>
                <b-col>
                  <div class="mb-0">
                    <b-form-checkbox id="s-startups-weekly">Startups Weekly</b-form-checkbox>
                  </div>
                </b-col>
                <b-col>
                  <div class="mb-0">
                    <b-form-checkbox id="s-podcasts">Podcasts</b-form-checkbox>
                  </div>
                </b-col>
              </b-row>
            </b-col>
          ...
          <!-- Email field -->
          <b-form class="d-flex flex-sm-row flex-column mb-3">
            <div class="input-group me-sm-3 mb-sm-0 mb-3">
              <b-form-input
                type="email"
                class="form-control-lg rounded-3 ps-5"
                placeholder="Your email"
                required
              />
              <Icon
                :icon="EnvelopeIcon"
                class="position-absolute start-0 top-50 translate-middle-y ms-3 zindex-5 fs-5 text-muted"
              />
              <b-form-invalid-feedback class="invalid-tooltip position-absolute start-0 top-0 mt-n4"
                >Please provide a valid email address!
              </b-form-invalid-feedback>
            </div>
            <b-button variant="primary" size="lg" type="submit">Subscribe *</b-button>
          </b-form>
          <b-form-text class="fs-sm text-sm-start text-center">
