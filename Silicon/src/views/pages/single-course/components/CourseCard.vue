<template>
  <article class="card h-100 border-0 shadow-sm mx-2">
    <div class="position-relative">
      ...
      ></a>
      <span
        class="badge bg-danger position-absolute top-0 start-0 zindex-2 mt-3 ms-3"
        v-if="course.badge"
        >{{ course.badge }}!</span
      >
      <a
    ...
    <div class="card-footer d-flex align-items-center fs-sm text-muted py-4">
      <div class="d-flex align-items-center me-4">
        <Icon :icon="TimeIcon" class="fs-xl me-1"></Icon>
        {{ course.time }} hours
      </div>
      <div class="d-flex align-items-center">
        <Icon :icon="LikeIcon" class="fs-xl me-1"></Icon>
        {{ course.like }}
      </div>
    </div>
  </article>
...
import Bookmark from '@iconify/icons-bx/bx-bookmark'
