<template>
  <section class="pt-2 pb-lg-4 pb-xl-5 mb-5">
    <h2 class="h1 text-center pb-3 pb-md-4 pb-xl-5">Why students love this course</h2>
...
import TestimonialCard from '@/views/pages/single-course/components/TestimonialCard.vue'
