<template>
  <b-container class="mb-5 pt-4 pb-2 py-mg-4">
    <b-row class="gy-4">
      <!-- Content -->
      <b-col lg="9">
        <h3 class="h5 mb-4 pb-2 fw-medium">
      ...
      <b-col lg="3" class="position-relative">
        <div class="sticky-top ms-xl-5 ms-lg-4 ps-xxl-4" style="top: 105px !important">
          ...
          <b-button size="lg" variant="outline-secondary">
            <Icon :icon="LikeIcon" class="me-2 lead" />
            Like it
            <b-badge variant="primary" class="text-white shadow-primary mt-n1 ms-3">8</b-badge>
          </b-button>
        </div>
      </b-col>
    </b-row>
