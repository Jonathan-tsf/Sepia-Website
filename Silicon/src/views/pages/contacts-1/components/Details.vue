<template>
  <b-container class="py-5 my-md-2 my-lg-4 my-xl-5">
    <b-row class="justify-content-center pt-5 pb-1 pb-sm-2 pb-md-3">
      <b-col xxl="8" xl="9" lg="10" class="pt-sm-2 pt-md-5">
        <div class="d-sm-flex">
          <div
          ...
          >
            ...
            <div class="card-footer border-0 p-0">
              <a href="mailto:Info.bysepia@gmail.com" class="btn btn-lg btn-primary">Send email</a>
            </div>
          </div>
