...
export const moreFeatureData: MoreFeatureType[] = [
  {
    ...
    description:
      'Sepia is the powerful front-end solution based on Bootstrap 5 — the world’s most popular responsive, mobile-first front-end component library.'
  },
  {
    icon: FileIcon,
  ...
  },
  {
    ...
    description: `It's not a surprise that nowadays over 80% of users surf the inernet using their mobile devices. Sepia is 100% responsive and optimized for small touch screens.`
  },
  {
    icon: Html5Icon,
    title: 'W3C Valid HTML Code',
    description:
      'All HTML files are checked via W3C validator to ensure 100% valid code. As you probably know invalid HTML limits innovation, but Sepia is innovative at its core.'
  },
  {
    icon: NodejsIcon,
  ...
  },
  {
    ...
    description:
      'Sepia is built using Sass. Easily change colors, typography and much more. It is the most mature, stable, and powerful CSS extension language in the world.'
  },
  {
    icon: JavascriptIcon,
    title: 'Future Proof Java-Script',
    description:
      'Sepia core scripts as well as all dependencies are written in vanilla JS. And now with Bootstrap 5 we finally drop jQuery and use ES6 modules.'
  }
  // {
  //   icon: '',
