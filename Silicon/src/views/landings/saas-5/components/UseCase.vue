<template>
  <section class="position-relative overflow-hidden py-5">
    <span
      class="position-absolute top-0 start-0 w-100 h-100 d-dark-mode-none"
      style="background: linear-gradient(141deg, rgba(255, 255, 255, 0.01) 17.3%, #f3f6ff 78.21%)"
    ></span>
    <div
      class="position-absolute top-0 start-0 w-100 h-100 d-none d-dark-mode-block"
      style="
        background: linear-gradient(
          141deg,
          rgba(11, 15, 25, 0.01) 17.3%,
          rgba(255, 255, 255, 0.04) 78.21%
        );
      "
    ></div>

    <b-container class="position-relative zindex-2 pt-2 pt-sm-3 pt-md-4 pt-lg-5 mt-xl-3">
      <h2 class="h1 text-center pb-1 mb-2">What you can build with Silicon</h2>
      <p class="fs-lg text-center pb-lg-2">Well, lots of things. Some of them are listed below</p>

      <!-- Use case -->
      <b-row
        class="align-items-center justify-content-center py-4 py-md-5 my-1 my-sm-3 my-md-0 my-xl-3"
      >
        <b-col
          cols="11"
          sm="9"
          md="7"
          lg="6"
          class="offset-lg-1 order-md-2 pb-2 pb-sm-3 pb-md-0 mb-4 mb-md-0"
        >
          <Parallax custom-class="parallax" :custom-style="{ maxWidth: '636px' }">
            ...
            <div class="parallax-layer" style="padding-right: 24.2%" data-depth="0.1">
              <img
                :src="lineChartLightImg"
                class="d-dark-mode-none position-relative rounded-3"
                style="
                  top: 27.5%;
                  max-width: 482px;
                  box-shadow: 0 12px 48px -8px rgba(189, 196, 221, 0.35);
                "
                alt="Total users line chart"
              />
              <img
                :src="lineChartDarkImg"
                class="d-none d-dark-mode-block position-relative rounded-3"
                style="
                  top: 27.5%;
                  max-width: 482px;
                  box-shadow: 0px 12px 48px -8px rgba(8, 11, 18, 0.4);
                "
                alt="Total users line chart"
              />
            </div>
            <div class="parallax-layer" style="padding-left: 45.75%" data-depth="-0.12">
              <img
                :src="barChartLightImg"
                class="d-dark-mode-none position-relative rounded-3"
                style="
                  max-width: 345px;
                  box-shadow: 0 10.8px 43.2px -7.2px rgba(189, 196, 221, 0.35);
                "
              ...
              <img
                :src="barChartDarkImg"
                class="d-none d-dark-mode-block position-relative rounded-3"
                style="max-width: 345px; box-shadow: 0px 12px 48px -8px rgba(8, 11, 18, 0.4)"
                alt="Traffic bar chart"
              />
            </div>
            <div
              class="parallax-layer"
              style="padding-right: 7.547%; padding-left: 44.97%"
              data-depth="0.3"
            >
              <img
                :src="donutChartLightImg"
                class="d-dark-mode-none position-relative rounded-3"
                style="
                  top: 60.75%;
                  max-width: 302px;
                  box-shadow: 0px 0px 48px -4px rgba(189, 196, 221, 0.35);
                "
                alt="Traffic donut chart"
              />
              <img
                :src="donutChartDarkImg"
                class="d-none d-dark-mode-block position-relative rounded-3"
                style="
                  top: 60.75%;
                  max-width: 302px;
                  box-shadow: 0px -15px 48px -8px rgba(8, 11, 18, 0.4);
                "
                alt="Traffic donut chart"
              />
            </div>
        ...
        <b-col md="5" xl="4" class="offset-xl-1 order-md-1 text-center text-md-start">
          ...
          <p class="fs-lg pb-lg-2 mb-4">
            From complex analysis to stunning visualizations, our advanced AI technology can help
            you extract valuable insights and make data-driven decisions faster than ever before.
          </p>
          <a href="#" class="btn btn-outline-primary rounded-pill">
            Learn more
            <Icon :icon="RightArrowAltIcon" class="bx fs-lg ms-2 me-n1"></Icon>
          </a>
        </b-col>
      </b-row>
      ...
      <!-- Use case -->
      <b-row
        class="align-items-center justify-content-center justify-content-md-start py-4 py-md-5 my-2 my-sm-3 my-md-0 my-xl-3"
      >
        <b-col cols="11" sm="9" md="7" lg="6" class="pb-2 pb-sm-3 pb-md-0 mb-4 mb-md-0">
          <Parallax custom-class="parallax" :custom-style="{ maxWidth: '636px' }">
            <div class="parallax-layer" data-depth="0.05">
              <img :src="circle1Img" alt="Circle 1" />
            </div>
            <div class="parallax-layer" data-depth="0.1">
              <img :src="circle2Img" alt="Circle 2" />
            </div>
            <div class="parallax-layer" data-depth="0.15">
              <img :src="circle3Img" alt="Circle 3" />
            </div>
            ...
            <div
              class="parallax-layer"
              style="padding-right: 28.7%; padding-left: 57%"
              data-depth="0.3"
            >
              <div class="position-relative">
                ...
                <span
                  ...
                  style="box-shadow: 0 12px 48px -8px rgba(189, 196, 221, 0.35)"
                ></span>
                <span
                  class="position-absolute top-0 start-0 w-100 h-100 rounded-circle d-none d-dark-mode-block"
                  style="background-color: #212435"
                ></span>
                <svg
                  class="position-absolute top-0 start-0 zindex-2 text-dark"
                  viewBox="0 0 92 91"
                  fill="currentColor"
            ...
            <div
              class="parallax-layer"
              style="padding-right: 60%; padding-left: 27.6%"
              data-depth="0.45"
            >
              <div class="position-relative" style="top: 13.3%">
                ...
                ></span>
                <svg
                  class="position-absolute top-0 start-0 zindex-2"
                  viewBox="0 0 80 80"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                >
            ...
            <div
              class="parallax-layer"
              style="padding-right: 27.8%; padding-left: 62.9%"
              data-depth="0.35"
            >
              <div class="position-relative" style="top: 30.7%">
                ...
                <span
                  class="position-absolute top-0 start-0 w-100 h-100 bg-white rounded-circle d-dark-mode-none"
                  style="box-shadow: 0 12px 48px -8px rgba(189, 196, 221, 0.45)"
                ></span>
                <span
                  class="position-absolute top-0 start-0 w-100 h-100 rounded-circle d-none d-dark-mode-block"
                  style="background-color: #212435"
            ...
            <div
              class="parallax-layer"
              style="padding-right: 73.3%; padding-left: 11.1%"
              data-depth="0.25"
            >
            ...
            <div
              class="parallax-layer"
              style="padding-right: 68.2%; padding-left: 21%"
              data-depth="0.4"
            >
              <div class="position-relative" style="top: 52.9%">
                ...
                <span
                  class="position-absolute top-0 start-0 w-100 h-100 bg-white rounded-circle d-dark-mode-none"
                  style="box-shadow: 0 12px 48px -8px rgba(189, 196, 221, 0.4)"
                ></span>
                <span
                  class="position-absolute top-0 start-0 w-100 h-100 rounded-circle d-none d-dark-mode-block"
                  style="background-color: #212435"
            ...
            <div
              class="parallax-layer"
              style="padding-right: 16%; padding-left: 71.4%"
              data-depth="0.3"
            >
        ...
        <b-col md="5" xl="4" class="offset-lg-1 text-center text-md-start">
          ...
          <p class="fs-lg pb-lg-2 mb-4">
            Integrate our smart AI with the tools you already know and use. 10x times increase your
      ...
      <!-- Use case -->
      <b-row
        class="align-items-center justify-content-center py-4 py-md-5 my-2 my-sm-3 my-md-0 my-xl-3"
      >
        <b-col
          cols="11"
          sm="9"
        ...
        >
          <Parallax custom-class="parallax" :custom-style="{ maxWidth: '636px' }">
            <div class="parallax-layer" data-depth="0.1">
              <img
                :src="windowLightImg"
                class="d-dark-mode-none rounded-3"
                style="box-shadow: 0 10.2px 41px -6.8px rgba(189, 196, 221, 0.3)"
                alt="Chat bot UI window"
              />
              <img
                :src="windowDarkImg"
                class="d-none d-dark-mode-block rounded-3"
                style="box-shadow: 0 8px 30px -4px rgba(8, 11, 18, 0.35)"
                alt="Chat bot UI window"
              />
            </div>
            <div class="parallax-layer" data-depth="0.15">
              <img :src="message1LightImg" class="d-dark-mode-none" alt="Message" />
              <img :src="message1DarkImg" class="d-none d-dark-mode-block" alt="Message" />
            </div>
            <div class="parallax-layer" data-depth="0.25">
              <img :src="message2LightImg" class="d-dark-mode-none" alt="Message" />
              <img :src="message2DarkImg" class="d-none d-dark-mode-block" alt="Message" />
            </div>
            <div class="parallax-layer" data-depth="0.35">
              <img :src="message3LightImg" class="d-dark-mode-none" alt="Message" />
              <img :src="message3DarkImg" class="d-none d-dark-mode-block" alt="Message" />
            </div>
          </Parallax>
        </b-col>
        <b-col md="5" xl="4" class="offset-xl-1 order-md-1 text-center text-md-start">
          ...
          <p class="fs-lg pb-lg-2 mb-4">
            Seamlessly integrate natural language processing and machine learning capabilities into
            your chat bot and provide a personalized experience to your end users.
          </p>
          <a href="#" class="btn btn-outline-primary rounded-pill">
            Learn more
            <Icon :icon="RightArrowAltIcon" class="bx fs-lg ms-2 me-n1"></Icon>
...
import lineChartLightImg from '@/assets/img/landing/saas-5/use-cases/data-analysis/line-chart-light.png'
import lineChartDarkImg from '@/assets/img/landing/saas-5/use-cases/data-analysis/line-chart-dark.png'
import barChartLightImg from '@/assets/img/landing/saas-5/use-cases/data-analysis/bar-chart-light.png'
import barChartDarkImg from '@/assets/img/landing/saas-5/use-cases/data-analysis/bar-chart-dark.png'
import donutChartLightImg from '@/assets/img/landing/saas-5/use-cases/data-analysis/donut-chart-light.png'
import donutChartDarkImg from '@/assets/img/landing/saas-5/use-cases/data-analysis/donut-chart-dark.png'
import circle1Img from '@/assets/img/landing/saas-5/use-cases/task-automation/circle-1.png'
import circle2Img from '@/assets/img/landing/saas-5/use-cases/task-automation/circle-2.png'
import circle3Img from '@/assets/img/landing/saas-5/use-cases/task-automation/circle-3.png'
import windowLightImg from '@/assets/img/landing/saas-5/use-cases/chat-bot/window-light.png'
import windowDarkImg from '@/assets/img/landing/saas-5/use-cases/chat-bot/window-dark.png'
import message1LightImg from '@/assets/img/landing/saas-5/use-cases/chat-bot/message1-light.png'
import message1DarkImg from '@/assets/img/landing/saas-5/use-cases/chat-bot/message1-dark.png'
import message2LightImg from '@/assets/img/landing/saas-5/use-cases/chat-bot/message2-light.png'
import message2DarkImg from '@/assets/img/landing/saas-5/use-cases/chat-bot/message2-dark.png'
import message3LightImg from '@/assets/img/landing/saas-5/use-cases/chat-bot/message3-light.png'
import message3DarkImg from '@/assets/img/landing/saas-5/use-cases/chat-bot/message3-dark.png'
