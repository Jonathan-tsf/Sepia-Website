<template>
  ...
  <section class="bg-secondary overflow-hidden py-2 py-sm-3 py-md-4 py-lg-5">
    <b-container class="py-5 pb-lg-4">
      <b-row>
        <!-- Cursor parallax -->
        <b-col md="" class="offset-xl-1 order-md-2">
          <Parallax custom-class="parallax" :custom-style="{ maxWidth: '746px' }">
            <div class="parallax-layer" data-depth="0.1">
              <img :src="mobileApp1Img" alt="Phone" />
            </div>
            <div class="parallax-layer" data-depth="0.3">
              <img :src="mobileApp2Img" alt="Phone" />
            </div>
            <div class="parallax-layer" data-depth="-0.1">
              <img :src="mobileApp3Img" alt="Phone" />
            </div>
            <div class="parallax-layer" data-depth="0.2">
              <img :src="mobileApp4Img" alt="Phone" />
            </div>
          </Parallax>
        </b-col>

        <!-- Text + Action buttons -->
        <b-col md="5" xl="4" class="order-md-1 text-center text-md-start pt-lg-3">
          <h2 class="display-5 mb-4">Easy way to find e-scooters</h2>
          <p class="fs-xl pb-2 mb-4 mb-xl-5">
            Electric scooters can be found by locating them on the App available for smartphones and
            smart watches.
          </p>
          ...
          <div class="d-flex justify-content-center justify-content-md-start">
            <a href="#" class="position-relative me-4" aria-label="App Store">
              <div
                class="bg-white rounded-3 shadow position-absolute top-0 start-0 w-100 h-100 d-dark-mode-none"
              ></div>
              <div
                class="rounded-3 position-absolute top-0 start-0 w-100 h-100 d-none d-dark-mode-block"
                style="background-color: rgba(255, 255, 255, 0.06)"
              ></div>
              <svg
                class="position-relative zindex-2 text-dark"
                width="80"
                height="80"
                viewBox="0 0 80 80"
                fill="currentColor"
            ...
            <a href="#" class="position-relative" aria-label="Google Play">
              ...
              ></div>
              <svg
                class="position-relative zindex-2"
                xmlns="http://www.w3.org/2000/svg"
                width="80"
                height="80"
                fill="none"
...
import mobileApp1Img from '@/assets/img/landing/startup/mobile-app/01.png'
import mobileApp2Img from '@/assets/img/landing/startup/mobile-app/02.png'
import mobileApp3Img from '@/assets/img/landing/startup/mobile-app/03.png'
import mobileApp4Img from '@/assets/img/landing/startup/mobile-app/04.png'
