        ...
        <b-col xl="8" lg="9" md="11">
            ...
            <b-col md="9">
              <b-row class="row-cols-sm-3 row-cols-2 gy-2">
                <b-col v-for="option in options">
                  <b-form-checkbox v-model="selected" :key="option.value" :value="option.value"
                    >{{ option.text }}
                  </b-form-checkbox>
                </b-col>
              </b-row>
          ...
          <b-form class="d-flex flex-sm-row flex-column mb-3">
            <div class="input-group me-sm-3 mb-sm-0 mb-3">
              ...
              />
              <div class="invalid-tooltip position-absolute start-0 top-0 mt-n4">
                Please provide a valid email address!
              </div>
            </div>
            <b-button size="lg" variant="primary" type="submit">Subscribe *</b-button>
          </b-form>
...
const selected = ref('advertising_updates')

const options = [
  { text: 'Daily Newsletter', value: 'daily_newsletter' },
  { text: 'Advertising Updates', value: 'advertising_updates' },
  { text: 'Week in Review', value: 'week_review' },
  { text: 'Event Updates', value: 'event_updates' },
  { text: 'Startups Weekly', value: 'startups_weekly' },
