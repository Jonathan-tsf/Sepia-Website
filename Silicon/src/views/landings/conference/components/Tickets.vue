<template>
  <b-container class="pb-5 mb-2 mb-md-4 mb-lg-5 mt-n3 mt-lg-0">
    <b-row class="pt-xl-2 pb-md-3">
      <b-col lg="5" class="mb-4 mb-lg-0">
        <h2 class="h1 text-center text-sm-start mb-4">The Biggest Digital Event in 2023</h2>
        <p class="pb-2 pb-lg-4 pb-xl-5 mb-3">
          Et, morbi at sagittis vehicula rutrum. Lacus tortor, quam arcu mi et, at lectus leo nunc.
          Mattis cras auctor vel pharetra tempor. Rhoncus pellentesque habitant ac tempor. At
          aliquam euismod est in praesent ornare etiam id. Faucibus libero sit vehicula sed
          condimentum. Vitae in nam porttitor rutrum sed aliquam donec sed. Sapien facilisi lectus.
        </p>
      ...
      <b-col xl="6" lg="7" class="offset-xl-1 position-relative">
        <!-- Ticket card -->
            ...
            <div class="px-md-4 position-relative zindex-5">
              <div class="d-sm-flex align-items-start justify-content-between">
                ...
                <div class="d-table bg-white rounded-3 p-4 flex-shrink-0 mx-auto mx-sm-0">
                  <img :src="qr" :width="102" alt="QR Code" />
                </div>
              </div>
        ...
        <!-- Arrow -->
        <div
          class="position-absolute bottom-0 text-primary d-none d-lg-block ms-xl-n5 mb-lg-5 mb-xl-4 pb-3"
        >
          <div class="ms-xl-n4">
            <svg
              width="95"
...
import cardPattern from '@/assets/img/landing/conference/price-card-pattern.png'
import qr from '@/assets/img/landing/conference/qr.png'
</script>
