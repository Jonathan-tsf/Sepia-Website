import csm from '@/assets/img/services/icons/cms.svg'
...
import type {
  ...
  BrandType,
  NewsType
} from '@/views/landings/dev-agency-1/type'
...
const categories: string[] = ['Tech', 'Strategy', 'Software', 'Startups', 'Technology']
