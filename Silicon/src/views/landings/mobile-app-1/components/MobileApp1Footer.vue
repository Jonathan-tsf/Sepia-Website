  ...
  <footer class="footer pt-5 pb-4 pb-lg-5">
    <b-container class="text-center pt-lg-3">
      <div class="navbar-brand justify-content-center text-dark mb-2 mb-lg-4">
        <img :src="logoImg" class="me-2" width="60" alt="Sépia" />
      ...
      <div class="d-flex flex-column flex-sm-row justify-content-center">
        <a href="#" class="btn btn-dark btn-lg px-3 py-2 me-sm-4 mb-3">
          <img :src="appStoreLgtImg" class="light-mode-img" width="124" alt="App Store" />
          <img :src="appStoreDarkImg" class="dark-mode-img" width="124" alt="App Store" />
        </a>
        <a href="#" class="btn btn-dark btn-lg px-3 py-2 mb-3">
          <img :src="googlePlayLgtImg" class="light-mode-img" width="139" alt="Google Play" />
...
import appStoreLgtImg from '@/assets/img/market/appstore-light.svg'
import appStoreDarkImg from '@/assets/img/market/appstore-dark.svg'
import googlePlayLgtImg from '@/assets/img/market/googleplay-light.svg'
import googlePlayDarkImg from '@/assets/img/market/googleplay-dark.svg'
import { Icon } from '@iconify/vue'
import { FacebookIcon, InstagramIcon, TwitterIcon, YoutubeIcon } from '../data'
</script>
